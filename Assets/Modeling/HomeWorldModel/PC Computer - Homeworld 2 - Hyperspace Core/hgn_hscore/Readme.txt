...
Note: This model (Hyperspace Core) only has one LOD level for the entire thing (LOD0). 
...
LOD (Level of Detail/Loss of Detail) is the degrading of the models quality as it gets farther from the camera. This allows for much improved performance in the game.
